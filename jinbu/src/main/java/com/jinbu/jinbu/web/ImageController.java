...
public class ImageController {
    ...
    public ResponseEntity<Photo> retrieveLocalMetadata(@RequestParam("file") MultipartFile file) throws IOException {
        return new ResponseEntity<>(imageService.retrieveLocalMetadata(file), HttpStatus.CREATED);
    }
